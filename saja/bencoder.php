...
# BENCODER v1.4 - Shen Cheng-Da (cdsheen at gmail.com)
# Project home: http://bencoder.urdada.net/

$title = 'BENCODER v1.4 - Encode your PHP script using bcompiler';
...
if( !function_exists( 'bcompiler_write_file' ) ) {
	...
	print "  cmd> pecl install channel://pecl.php.net/bcompiler-0.9.3\n\n";
