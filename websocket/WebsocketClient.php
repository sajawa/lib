...
class Client extends Base {
  ...
  public function __construct($uri, $options = array()) {
    ...
    if (!array_key_exists('timeout', $this->options)) $this->options['timeout'] = 1;
    $this->socket_uri = $uri;
  }
  ...
  protected function connect() {
    ...
    // Get server response.
    $response = '';
	// Change to fread by Thomas 20150209
	$response=fread($this->socket,4096);
	/*
	do {
	  // error_log("stream get line ....");
